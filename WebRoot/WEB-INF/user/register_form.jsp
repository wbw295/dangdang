...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/user/verify_regist.js">
</script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="regist!submit" id="f">
				<h2>
					以下均为必填项
				</h2>
				<table class="tab_login">
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="checkCode" />
							...
							<div class="text_left t1">
								<p class="t1">
									...
									<a href="javascript:;" id="replace">看不清楚？换个图片</a>
								</p>
							</div>
						</td>
					</tr>
