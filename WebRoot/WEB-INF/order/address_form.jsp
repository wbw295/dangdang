...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/order/load_address.js">
</script>
		<script type="text/javascript" src="../js/order/verify_address.js">
</script>
			...
			<form name="ctl00" method="post" action="orderSubmit" id="f">
				...
				<table class="tab_login">
					<tr>
						...
						<td>
							<input type="text" name="address.receiveName" id="receiveName"
								class="text_input" />
				...
				<div class="login_in">
					<input type="reset" id="reset" style="display: none">
						...
						<a href="orderInfo"><input id="btnClientRegister"
